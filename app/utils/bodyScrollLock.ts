...
// From https://github.com/vercel/body-scroll-lock/blob/master/src/bodyScrollLock.js
// as the original body-scroll-lock is no longer being maintained and it
// contains a bug on iOS
