...
async function generateSvgSprite({
  ...
  const output = [
    ...
    `<linearGradient id="gradient-brand" x1="19.9997" y1="2.0835" x2="19.9997" y2="37.9168" gradientUnits="userSpaceOnUse">`,
    `<stop stop-color="#8954FF"></stop>`,
    `<stop offset="1" stop-color="#546DFF"></stop>`,
    `</linearGradient>`,
    `</defs>`,
    ...symbols,
    `</svg>`,
